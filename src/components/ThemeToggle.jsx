...
/**
 * مكون زر تبديل الوضع الليلي/النهاري
 */
const ThemeToggle = ({ currentTheme, toggleTheme, language }) => {
  const t = {
    ar: {
  ...
  return (
    <button 
      ...
      onClick={toggleTheme}
      aria-label={currentTheme === 'light' ? t[language].darkMode : t[language].lightMode}
      title={currentTheme === 'light' ? t[language].darkMode : t[language].lightMode}
    >
      {currentTheme === 'light' ? (
